      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-16">
              ...
              >
                {!isLogoFailedAll ? (
                  ...
                  <div className="flex items-center gap-1.5 bg-slate-900 border border-slate-800 px-3 py-2 rounded-xl shadow-md">
                    <span className="text-orange-400 font-sans font-black text-xs sm:text-sm tracking-tight">Asociación</span>
                    <span className="text-white font-sans font-black text-xs sm:text-sm bg-orange-600 px-2 py-0.5 rounded-lg">Horuelo</span>
                  </div>
                )}
              </a>
              <div>
                <h4 className="font-sans font-black text-lg text-white leading-tight tracking-tight">Aula Intercultural</h4>
                <p className="font-mono text-[9px] text-orange-400 uppercase tracking-widest font-extrabold mt-0.5">Asociación Horuelo</p>
              </div>
            </div>
            
            <p className="font-sans text-xs text-slate-400 leading-relaxed max-w-sm">
              Un rincón pedagógico interactivo de libre distribución para la formación de docentes de cualquier etapa (desde infantil hasta secundaria), diseñado para transformar aulas a través del respeto activo, la decolonialidad y la justicia social.
            </p>
          ...
          <div className="lg:col-span-3 space-y-5">
            <h5 className="font-mono text-[10px] uppercase tracking-widest text-orange-400 font-extrabold flex items-center gap-2">
            ...
            <ul className="space-y-3 font-sans text-xs">
              <li>
                ...
                >
                  <span className="h-1.5 w-1.5 rounded-full bg-slate-700 group-hover:bg-orange-400 transition-colors" />
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-orange-300 text-[10px] font-sans font-bold uppercase tracking-wider">
              <Sparkles className="w-3.5 h-3.5 text-orange-400 animate-pulse" /> Cumplimiento WCAG 2.1 AA
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="space-y-3 font-sans text-xs">
              ...
              >
                ...
                <ArrowUpRight className="w-3.5 h-3.5 text-slate-500 group-hover:text-orange-400 transition-colors" />
              </a>
              <a 
              ...
              >
                ...
                <Mail className="w-3.5 h-3.5 text-slate-500 group-hover:text-orange-400 transition-colors" />
              </a>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-850 flex flex-col md:flex-row items-center justify-between gap-5 font-sans text-[11px] text-slate-500">
          <div className="space-y-1 text-center md:text-left">
            ...
            <p className="text-slate-550 text-[10px]">
              Fichas didácticas de libre distribución para uso pedagógico no lucrativo en colegios, institutos y centros educativos.
            </p>
          </div>
